...
for mon in month: #loop through the files; the MAR melting data and the AR indicies 
	...
	file1 = "/home/jwille/xenon_data/IGE_data/vIVT_IWV/ERA5/coarse/80_23/vIVT/lat_rst_ant_vIVT_ERA5_2DIVT_"+mon+"_80_23.nc"
...
#Run the algorithm
	...
	np.save('/home/jwille/xenon_data/IGE_data/ar_catalogues/era5/coord_idx/'+mon+'_80_23_ant_vivt_lat_idx_v2.4',lat_index_list)
	np.save('/home/jwille/xenon_data/IGE_data/ar_catalogues/era5/coord_idx/'+mon+'_80_23_ant_vivt_lon_idx_v2.4',lon_index_list)
