...
for mon in month: #loop through the files; the MAR melting data and the AR indicies 
	...
	file1 = "/home/jwille/xenon_data/IGE_data/vIVT_IWV/ERA5/coarse/80_23/IWV/lat_rst_arctic_IWV_ERA5_2DIVT_"+mon+"_80_23.nc"
	print(file1)
	#Read in data
	...
	iwv_full = None
	iwv = None
	np.save('/home/jwille/xenon_data/IGE_data/ar_catalogues/era5/coord_idx/'+mon+'_80_23_arc_iwv_lat_idx_v2.4',lat_index_list)
	np.save('/home/jwille/xenon_data/IGE_data/ar_catalogues/era5/coord_idx/'+mon+'_80_23_arc_iwv_lon_idx_v2.4',lon_index_list)
